...
THEORY ListOperationsX IS
  Internal_List_Operations(Machine(BASIC_IO))==(INTERVAL_READ,INT_WRITE,BOOL_READ,BOOL_WRITE,CHAR_READ,CHAR_WRITE,STRING_WRITE);
  List_Operations(Machine(BASIC_IO))==(INTERVAL_READ,INT_WRITE,BOOL_READ,BOOL_WRITE,CHAR_READ,CHAR_WRITE,STRING_WRITE)
END
&
THEORY ListInputX IS
  List_Input(Machine(BASIC_IO),INTERVAL_READ)==(aa,bb);
  List_Input(Machine(BASIC_IO),INT_WRITE)==(nn);
  List_Input(Machine(BASIC_IO),BOOL_READ)==(?);
  List_Input(Machine(BASIC_IO),BOOL_WRITE)==(bb);
  List_Input(Machine(BASIC_IO),CHAR_READ)==(?);
  List_Input(Machine(BASIC_IO),CHAR_WRITE)==(bb);
  List_Input(Machine(BASIC_IO),STRING_WRITE)==(ss)
END
&
THEORY ListOutputX IS
  List_Output(Machine(BASIC_IO),INTERVAL_READ)==(nn);
  List_Output(Machine(BASIC_IO),INT_WRITE)==(?);
  List_Output(Machine(BASIC_IO),BOOL_READ)==(bb);
  List_Output(Machine(BASIC_IO),BOOL_WRITE)==(?);
  List_Output(Machine(BASIC_IO),CHAR_READ)==(bb);
  List_Output(Machine(BASIC_IO),CHAR_WRITE)==(?);
  List_Output(Machine(BASIC_IO),STRING_WRITE)==(?)
END
&
THEORY ListHeaderX IS
  List_Header(Machine(BASIC_IO),INTERVAL_READ)==(nn <-- INTERVAL_READ(aa,bb));
  List_Header(Machine(BASIC_IO),INT_WRITE)==(INT_WRITE(nn));
  List_Header(Machine(BASIC_IO),BOOL_READ)==(bb <-- BOOL_READ);
  List_Header(Machine(BASIC_IO),BOOL_WRITE)==(BOOL_WRITE(bb));
  List_Header(Machine(BASIC_IO),CHAR_READ)==(bb <-- CHAR_READ);
  List_Header(Machine(BASIC_IO),CHAR_WRITE)==(CHAR_WRITE(bb));
...
THEORY ListPreconditionX IS
  List_Precondition(Machine(BASIC_IO),INTERVAL_READ)==(aa: INT & bb: INT & aa<=bb);
  List_Precondition(Machine(BASIC_IO),INT_WRITE)==(nn: INT);
  List_Precondition(Machine(BASIC_IO),BOOL_READ)==(btrue);
  List_Precondition(Machine(BASIC_IO),BOOL_WRITE)==(bb: BOOL);
  List_Precondition(Machine(BASIC_IO),CHAR_READ)==(btrue);
  List_Precondition(Machine(BASIC_IO),CHAR_WRITE)==(bb: 0..255);
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Machine(BASIC_IO),CHAR_WRITE)==(bb: 0..255 | skip);
  Expanded_List_Substitution(Machine(BASIC_IO),CHAR_READ)==(btrue | @(bb$0).(bb$0: 0..255 ==> bb:=bb$0));
  Expanded_List_Substitution(Machine(BASIC_IO),BOOL_WRITE)==(bb: BOOL | skip);
  Expanded_List_Substitution(Machine(BASIC_IO),BOOL_READ)==(btrue | @(bb$0).(bb$0: BOOL ==> bb:=bb$0));
  Expanded_List_Substitution(Machine(BASIC_IO),INT_WRITE)==(nn: INT | skip);
  Expanded_List_Substitution(Machine(BASIC_IO),INTERVAL_READ)==(aa: INT & bb: INT & aa<=bb | @(nn$0).(nn$0: aa..bb ==> nn:=nn$0));
  List_Substitution(Machine(BASIC_IO),INTERVAL_READ)==(nn:: aa..bb);
  List_Substitution(Machine(BASIC_IO),INT_WRITE)==(skip);
  List_Substitution(Machine(BASIC_IO),BOOL_READ)==(bb:: BOOL);
  List_Substitution(Machine(BASIC_IO),BOOL_WRITE)==(skip);
  List_Substitution(Machine(BASIC_IO),CHAR_READ)==(bb:: 0..255);
  List_Substitution(Machine(BASIC_IO),CHAR_WRITE)==(skip);
...
THEORY ListANYVarX IS
  ...
  List_ANY_Var(Machine(BASIC_IO),BOOL_READ)==(?);
  List_ANY_Var(Machine(BASIC_IO),BOOL_WRITE)==(?);
  List_ANY_Var(Machine(BASIC_IO),CHAR_READ)==(?);
  List_ANY_Var(Machine(BASIC_IO),CHAR_WRITE)==(?);
...
THEORY OperationsEnvX IS
  Operations(Machine(BASIC_IO)) == (Type(STRING_WRITE) == Cst(No_type,btype(STRING,?,?));Type(CHAR_WRITE) == Cst(No_type,btype(INTEGER,?,?));Type(CHAR_READ) == Cst(btype(INTEGER,0,255),No_type);Type(BOOL_WRITE) == Cst(No_type,btype(BOOL,?,?));Type(BOOL_READ) == Cst(btype(BOOL,0,1),No_type);Type(INT_WRITE) == Cst(No_type,btype(INTEGER,?,?));Type(INTERVAL_READ) == Cst(btype(INTEGER,aa,bb),btype(INTEGER,?,?)*btype(INTEGER,?,?)));
  Observers(Machine(BASIC_IO)) == (Type(STRING_WRITE) == Cst(No_type,btype(STRING,?,?));Type(CHAR_WRITE) == Cst(No_type,btype(INTEGER,?,?));Type(CHAR_READ) == Cst(btype(INTEGER,0,255),No_type);Type(BOOL_WRITE) == Cst(No_type,btype(BOOL,?,?));Type(BOOL_READ) == Cst(btype(BOOL,0,1),No_type);Type(INT_WRITE) == Cst(No_type,btype(INTEGER,?,?));Type(INTERVAL_READ) == Cst(btype(INTEGER,aa,bb),btype(INTEGER,?,?)*btype(INTEGER,?,?)))
END
&
THEORY TCIntRdX IS
  predB0 == OK;
