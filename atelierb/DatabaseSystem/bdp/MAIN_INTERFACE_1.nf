...
THEORY ListConstantsX IS
  ...
  Inherited_List_Constants(Implementation(MAIN_INTERFACE_1))==(code_COMMAND,decode_COMMAND,code_SEX,decode_SEX,code_STATUS,decode_STATUS);
...
THEORY ListHiddenConstantsX IS
  ...
  Expanded_List_HiddenConstants(Implementation(MAIN_INTERFACE_1))==(?);
  List_HiddenConstants(Implementation(MAIN_INTERFACE_1))==(?);
  External_List_HiddenConstants(Implementation(MAIN_INTERFACE_1))==(?)
END
&
...
THEORY ListVisibleStaticX IS
  ...
  List_Constants(Implementation(MAIN_INTERFACE_1),Machine(BASIC_COMMAND))==(code_COMMAND,decode_COMMAND);
  List_Constants_Env(Implementation(MAIN_INTERFACE_1),Machine(BASIC_COMMAND))==(Type(new) == Cst(etype(COMMAND,0,5));Type(birth) == Cst(etype(COMMAND,0,5));Type(marriage) == Cst(etype(COMMAND,0,5));Type(death) == Cst(etype(COMMAND,0,5));Type(print) == Cst(etype(COMMAND,0,5));Type(quit) == Cst(etype(COMMAND,0,5));Type(code_COMMAND) == Cst(SetOf(etype(COMMAND,0,5)*btype(INTEGER,0,5)));Type(decode_COMMAND) == Cst(SetOf(btype(INTEGER,?,?)*etype(COMMAND,?,?))));
...
THEORY ListOfIdsX IS
  List_Of_Ids(Implementation(MAIN_INTERFACE_1)) == (? | code_STATUS,decode_STATUS,STATUS,dead,living,code_SEX,decode_SEX,SEX,man,woman,code_COMMAND,decode_COMMAND,COMMAND,new,birth,marriage,death,print,quit | ? | ? | main | ? | imported(Machine(INNER_INTERFACE)),imported(Machine(BASIC_COMMAND)),imported(Machine(BASIC_SEX)),imported(Machine(BASIC_STATUS)),imported(Machine(BASIC_IO)) | ? | MAIN_INTERFACE_1);
  List_Of_HiddenCst_Ids(Implementation(MAIN_INTERFACE_1)) == (? | ?);
  List_Of_VisibleCst_Ids(Implementation(MAIN_INTERFACE_1)) == (code_STATUS,decode_STATUS,code_SEX,decode_SEX,code_COMMAND,decode_COMMAND);
...
THEORY ConstantsEnvX IS
  Constants(Implementation(MAIN_INTERFACE_1)) == (Type(decode_COMMAND) == Cst(SetOf(btype(INTEGER,?,?)*etype(COMMAND,?,?)));Type(code_COMMAND) == Cst(SetOf(etype(COMMAND,0,5)*btype(INTEGER,0,5)));Type(quit) == Cst(etype(COMMAND,0,5));Type(print) == Cst(etype(COMMAND,0,5));Type(death) == Cst(etype(COMMAND,0,5));Type(marriage) == Cst(etype(COMMAND,0,5));Type(birth) == Cst(etype(COMMAND,0,5));Type(new) == Cst(etype(COMMAND,0,5));Type(decode_SEX) == Cst(SetOf(btype(INTEGER,?,?)*etype(SEX,?,?)));Type(code_SEX) == Cst(SetOf(etype(SEX,0,1)*btype(INTEGER,0,1)));Type(woman) == Cst(etype(SEX,0,1));Type(man) == Cst(etype(SEX,0,1));Type(decode_STATUS) == Cst(SetOf(btype(INTEGER,?,?)*etype(STATUS,?,?)));Type(code_STATUS) == Cst(SetOf(etype(STATUS,0,1)*btype(INTEGER,0,1)));Type(living) == Cst(etype(STATUS,0,1));Type(dead) == Cst(etype(STATUS,0,1)))
END
&
